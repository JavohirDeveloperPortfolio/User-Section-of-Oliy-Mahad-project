...
public class UserService {
    ...
    public RestAPIResponse register(UserRegisterDto registerDto){

        boolean existsByPhoneNumber = userRepository.existsByPhoneNumber(registerDto.getPhoneNumber());

        if (existsByPhoneNumber){
            return new RestAPIResponse("This phoneNumber is already exist!",false, HttpStatus.BAD_REQUEST);
        }
        ...
        return new RestAPIResponse("Successfully registered!", true, HttpStatus.OK);
    }
